    ...
    <section id="contact" className="py-[60px] md:py-[100px] container mx-auto px-6 md:px-8 max-w-[1200px]">
      <div className="bg-white rounded-[30px] md:rounded-[40px] shadow-[0_40px_100px_rgba(0,0,0,0.05)] grid grid-cols-1 md:grid-cols-2 border border-[var(--glass-border)] relative">
        <div className="p-8 md:p-12 lg:p-20 flex flex-col justify-center">
          ...
          <h2 className="text-3xl md:text-4xl font-cormorant font-semibold text-[var(--primary)] mb-6">Start Your Healing Journey</h2>
          <p className="text-[var(--text-light)] mb-10 text-lg leading-relaxed">
            Take the first step towards mental clarity. Our ethical clinical counseling provides a safe, non-judgmental space for your wellbeing.
          </p>
          ...
          <div className="space-y-6 text-[var(--text-dark)]">
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="font-semibold text-xs uppercase tracking-widest text-[var(--primary)] opacity-60 mb-1">Clinic Address</p>
                <p className="text-[15px] font-medium">Vikalp Khand, Jheel Road, Kathauta Jheel, Gomti Nagar, Lucknow</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="font-semibold text-xs uppercase tracking-widest text-[var(--primary)] opacity-60 mb-1">Direct Call</p>
                <a href="tel:+919793743769" className="text-[18px] font-semibold hover:text-[var(--primary)] transition-colors">97937 43769</a>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-[15px] font-medium">hello@theblissfulstation.in</p>
              </div>
            </div>
          </div>
        </div>
