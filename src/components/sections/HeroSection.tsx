...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden pt-[180px] pb-[15vw] container mx-auto px-8 max-w-[1200px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-16 text-center md:text-left">
        <div>
          <h1 className="text-5xl lg:text-[4rem] leading-tight mb-6 font-cormorant font-semibold bg-gradient-to-br from-[var(--primary)] to-[var(--primary-light)] bg-clip-text text-transparent">
            Rekindle Your <br /> Inner Peace
          </h1>
          <p className="text-xl text-[var(--text-light)] mb-10">
        ...
        <div className="relative mt-8 md:mt-0">
          <img
            src="/assets/hero_mental_wellness.png"
            alt="Mental Wellness Clinic Interior"
