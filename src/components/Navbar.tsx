...
export function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile Menu Overlay */}
      <div className={`fixed inset-0 z-[10001] bg-white transition-all duration-600 ease-in-out lg:hidden ${isMenuOpen ? 'translate-y-0 opacity-100' : '-translate-y-full opacity-0'}`}>
        <div className="flex flex-col h-full p-8">
          <div className="flex justify-between items-center mb-10">
            <div className="flex items-center gap-3">
              ...
              />
              <span className="text-lg font-cormorant font-bold text-[var(--primary)]">The Blissful Station</span>
            </div>
            <button 
